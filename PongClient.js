        ...
        if (lastInputOnServerSeqNo){
            ...
            if (lastAckInputIndex != -1){
                ...
                {   //
                    ...
                    {   //
                        if(latestServerUpdate.ballX - curState.ball.x > 20 || curState.ball.x - latestServerUpdate.ballX > 20 || latestServerUpdate.ballY - curState.ball.y > 20 || curState.ball.y - latestServerUpdate.ballY > 20)
                        {
